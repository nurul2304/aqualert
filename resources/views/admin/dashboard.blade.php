...
@section('content')
 ...
 <div class="grid grid-cols-2 gap-6 mb-8 overflow-x-auto">
  <div class="relative bg-white p-6 rounded-lg shadow overflow-x-auto">
    <img src="{{ asset('images/total_report.png') }}" alt="icon" class="hidden sm:block absolute top-4 right-4 w-12 h-12">
    <p class="text-gray-600">Total Report</p>
    <h2 class="text-2xl font-bold">197</h2>
    </div>

  <div class="relative bg-white p-6 rounded-lg shadow overflow-hidden">
    <img src="{{ asset('images/water_quality.png') }}" alt="icon" class="hidden sm:block absolute top-4 right-4 w-12 h-12">
