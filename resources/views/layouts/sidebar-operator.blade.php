            ...
            <ul class="space-y-4">
              ...
              <li>
                <a href="{{ route('visualdata') }}" class="flex items-center px-3 py-2 rounded font-semibold block 
                    ...
                    <i class="fas fa-chart-pie px-2 text-lg"></i>
                    <span>Visual Data</span>
                </a>
              </li>
              <li>
                <a href="{{ route('laporan-masuk') }}" class="flex items-center px-3 py-2 rounded font-semibold block 
                    {{ request()->routeIs('laporan-masuk') ? 'bg-blue-500 text-white' : 'text-gray-700 hover:bg-gray-200' }}">
